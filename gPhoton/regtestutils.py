...
def construct_row(i, band, objid, mcat, data):
    ...
    return (
        ...
        data["mcat_bg"][0],
        data["bg_counts"][0],
        data["flux_bgsub_err"][0],
        data["cps_mcatbgsub"][0],
        data["counts"][0],
        data["mag_mcatbgsub"][0],
        data["cps_err"][0],
        data["mag_bgsub"][0],
        data["cps_bgsub"][0],
        data["detys"][0],
        ...
        data["flux_err"][0],
        data["mag_err_1"][0],
        data["cps_bgsub_err"][0],
        data["t1_data"][0],
        data["bg"][0],
        data["responses"][0],
        data["t_mean"][0],
        data["cps_mcatbgsub_err"][0],
        data["mag_bgsub_err_1"][0],
        data["mag_err_2"][0],
        data["t0_data"][0],
        ...
        data["mag"][0],
        data["exptime"][0],
        data["bg_flat_counts"][0],
        data["detxs"][0],
        data["t0"][0],
        data["t1"][0],
        data["mag_mcatbgsub_err_2"][0],
        data["flux"][0],
        data["mag_mcatbgsub_err_1"][0],
        data["flags"][0],
        data["mag_bgsub_err_2"][0],
        data["detrad"][0],
        data["cps"][0],
        data["flux_mcatbgsub_err"][0],
        data["flux_mcatbgsub"][0],
        mcat[band]["expt"][i],
...
def datamaker(
    ...
    uniques = dt.find_unique_sources(
        band, skypos[0], skypos[1], searchradius, maglimit=maglimit
    )
    ...
    for pos in uniques:
        ...
        for i, objid in enumerate(mcat["objid"]):
            if mcat[band]["ra"][i] == -99.0 and mcat[band]["dec"][i] == -99.0:
            ...
            data = gAperture(
                band,
                [mcat[band]["ra"][i], mcat[band]["dec"][i]],
                radius,
                annulus=annulus,
                verbose=verbose,
                coadd=True,
